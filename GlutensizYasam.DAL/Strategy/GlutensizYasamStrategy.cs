...
namespace GlutensizYasam.DAL.Strategy
{
    internal class GlutensizYasamStrategy : CreateDatabaseIfNotExists<GlutensizYasamDbContext>
    {
        protected override void Seed(GlutensizYasamDbContext context)
        {
            ...
            Besin Bezelye = new Besin() { BesinAdi = "Bezelye", Protein = 16.26, Karbonhidrat = 43.3, Yag = 1.2, AktifMi = false };
            context.Besinler.Add(Bezelye);
            Besin Mercimek = new Besin() { BesinAdi = "Mercimek", Protein = 43.88, Karbonhidrat = 71.3, Yag = 2.67, AktifMi = false };
            context.Besinler.Add(Mercimek);
            Besin Fasulye = new Besin() { BesinAdi = "Fasulye", Protein = 34.8, Karbonhidrat = 47.07, Yag = 2.16, AktifMi = false };
            context.Besinler.Add(Fasulye);

            //Yağ Grubu
            Besin ZeytinYag = new Besin() { BesinAdi = "Zeytin Yağ", Protein = 0, Karbonhidrat = 0, Yag = 4.5, AktifMi = false };
            context.Besinler.Add(ZeytinYag);
            Besin AvokadoYag = new Besin() { BesinAdi = "Avokado Yağ", Protein = 0, Karbonhidrat = 0, Yag = 5, AktifMi = false };
            context.Besinler.Add(AvokadoYag);

            //Meyveler
            Besin Ananas = new Besin() { BesinAdi = "Ananas", Protein = 0.43, Karbonhidrat = 10.50, Yag = 0.10, AktifMi = false };
            context.Besinler.Add(Ananas);
            Besin Kayisi = new Besin() { BesinAdi = "Kayısı", Protein = 0.42, Karbonhidrat = 3.34, Yag = 0.12, AktifMi = false };
            context.Besinler.Add(Kayisi);
            Besin Kavun = new Besin() { BesinAdi = "Kavun", Protein = 2, Karbonhidrat = 11.84, Yag = 0.18, AktifMi = false };
            context.Besinler.Add(Kavun);
            Besin Erik = new Besin() { BesinAdi = "Erik", Protein = 0.70, Karbonhidrat = 11.42, Yag = 0.28, AktifMi = false };
            context.Besinler.Add(Erik);

            //Sebzeler
            Besin Salatalik = new Besin() { BesinAdi = "Salatalık", Protein = 0.78, Karbonhidrat = 4.36, Yag = 0.13, AktifMi = false };
            context.Besinler.Add(Salatalik);
            Besin Brokoli = new Besin() { BesinAdi = "Brokoli", Protein = 4.95, Karbonhidrat = 3.77, Yag = 0.30, AktifMi = false };
            context.Besinler.Add(Brokoli);
            Besin Patates = new Besin() { BesinAdi = "Patates", Protein = 4.37, Karbonhidrat = 37.25, Yag = 0.19, AktifMi = false };
            context.Besinler.Add(Patates);
            Besin Domates = new Besin() { BesinAdi = "Domates", Protein = 0.97, Karbonhidrat = 4.28, Yag = 0.22, AktifMi = false };
            context.Besinler.Add(Domates);

            //Glutenli Besinler
            Besin BeyazEkmek = new Besin() { BesinAdi = "Beyaz Ekmek", Protein = 2.67, Karbonhidrat = 10.98, Yag = 0.54, AktifMi = true };
            context.Besinler.Add(BeyazEkmek);
            Besin Makarna = new Besin() { BesinAdi = "Makarna", Protein = 5.22, Karbonhidrat = 27.53, Yag = 0.84, AktifMi = true };
            context.Besinler.Add(Makarna);
            Besin Bulgur = new Besin() { BesinAdi = "Bulgur", Protein = 3.61, Karbonhidrat = 23.64, Yag = 4.4, AktifMi = true };
            context.Besinler.Add(Bulgur);
            Besin Eriste = new Besin() { BesinAdi = "Erişte", Protein = 4.57, Karbonhidrat = 25.35, Yag = 13.6, AktifMi = true };
            context.Besinler.Add(Eriste);
            Besin Simit = new Besin() { BesinAdi = "Simit", Protein = 2.34, Karbonhidrat = 48.93, Yag = 5.15, AktifMi = true };
            context.Besinler.Add(Simit);
            Besin Cikolata = new Besin() { BesinAdi = "Cikolata", Protein = 0.22, Karbonhidrat = 2.9, Yag = 1.76, AktifMi = true };
            context.Besinler.Add(Cikolata);
            Besin Sucuk = new Besin() { BesinAdi = "Sucuk", Protein = 7.12, Karbonhidrat = 2.57, Yag = 14.19, AktifMi = true };
            context.Besinler.Add(Sucuk);
            Besin Krema = new Besin() { BesinAdi = "Krema", Protein = 6.6, Karbonhidrat = 9, Yag = 70, AktifMi = true };
            context.Besinler.Add(Krema);
            Besin Viski = new Besin() { BesinAdi = "Viski", Protein = 0, Karbonhidrat = 0.06, Yag = 0, AktifMi = true };
            context.Besinler.Add(Viski);
            Besin Irmik = new Besin() { BesinAdi = "İrmik", Protein = 1.27, Karbonhidrat = 7.28, Yag = 0.11, AktifMi = true };
            context.Besinler.Add(Irmik);
            Besin Kek = new Besin() { BesinAdi = "Kek", Protein = 3.18, Karbonhidrat = 23.53, Yag = 6.54, AktifMi = true };
            context.Besinler.Add(Kek);
            Besin Pogaca = new Besin() { BesinAdi = "Pogaca", Protein = 4.91, Karbonhidrat = 22.33, Yag = 14.74, AktifMi = true };
